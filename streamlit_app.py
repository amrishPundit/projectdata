...
st.title("Malware Detection using Machine learning Algorithm")
st.markdown(""" 
Malwares can come easily  on a computer and its network. Hackers use it to steal passwords, delete files and render computers inoperable. A malware infection can cause many problems that affect daily operation and the long-term security of your company.
